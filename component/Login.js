...
import {
  Container, Content, Form, Button, Toast, Spinner,
} from 'native-base';
import { Input, Icon } from 'react-native-elements';
import Modal, {
  ModalContent, ModalTitle, ModalFooter, ModalButton,
...
const Login = ({ navigation }) => {
  ...
  const toast = store.request.status === 'failed'
    ? Toast.show(
      {
      ...
      <Content>
        ...
        <View style={style.viewInput}>
          <Form style={style.form}>
            ...
            />
            <Button disabled={store.login.status === 'loading'} block style={style.but} onPress={() => submit()}>
        ...
        <Overlay isVisible={store.login.status === 'loading'}>
